...
yesterday_temp_val =  soup.find('div', class_='fact__time-yesterday-wrap').find('span', class_='temp__value temp__value_with-unit').get_text()
# print('Вчера в это время: ' + yesterday_temp_val)
now_temp_val = soup.find('div', class_='temp fact__temp fact__temp_size_s').find('span', class_='temp__value temp__value_with-unit').get_text()
# print('Сейчас: ' + now_temp_val)
feelings_temp_val = soup.find('div', class_='link__feelings fact__feelings').find('span', class_='temp__value temp__value_with-unit').get_text()
...
sun_rise_val = soup.find('div', class_='sun-card__sunrise-sunset-info sun-card__sunrise-sunset-info_value_rise-time').get_text()
...
val = soup.find_all('div')#.find('span', class_='temp__value temp__value_with-unit').get_text()
